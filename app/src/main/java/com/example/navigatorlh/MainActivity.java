package com.example.navigatorlh;/*
...
public class MainActivity extends Activity {
    ...
    private void openMap(Uri uri) {
        try {
             ...
             * Note: this map position is specific to Le havre area.
             */
            LatLong leHavreCoordinates = new LatLong(49.4938, 0.1087); // Latitude and Longitude of Le Havre
            mapView.getModel().mapViewPosition.setCenter(leHavreCoordinates);
            mapView.getModel().mapViewPosition.setZoomLevel((byte) 12); // Adjust the zoom level as needed
        } catch (Exception e) {
            /*
